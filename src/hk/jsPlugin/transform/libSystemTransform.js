...
var STATIC_BASE = 1024,
    ...
    STACKTOP = STACK_BASE,
    STACK_MAX = 295392,
    DYNAMIC_BASE = 5538272,
    DYNAMICTOP_PTR = 295216;
...
// {{PRE_LIBRARY}}
  ...
  var ___tm_current=295232;
  
  
  var ___tm_timezone=(stringToUTF8("GMT", 295280, 4), 295280);
...
/** @type {function(...*):?} */
var _SysTransInputAudioPara = Module["_SysTransInputAudioPara"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["SysTransInputAudioPara"].apply(null, arguments)
};
...
/** @type {function(...*):?} */
var _SysTransConfig = Module["_SysTransConfig"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["SysTransConfig"].apply(null, arguments)
};
